...
---
name: ql-audit
description: Adversarial audit of blueprint to generate mandatory PASS/VETO verdict. Use when Codex needs to review architecture plans before implementation for: (1) L2/L3 risk grade work, (2) Security-critical paths, (3) Architecture changes, or any work requiring formal approval before proceeding.
---
