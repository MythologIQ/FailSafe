...
Template: `.Codex/commands/references/ql-substantiate-templates.md`.
...
If any skill files (`.Codex/commands/ql-*.md`) were modified during this session:
...
Reference implementation: `.Codex/commands/scripts/calculate-session-seal.py`.
