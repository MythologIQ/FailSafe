...
Template: `.Codex/commands/references/ql-implement-patterns.md`.
...
Checklist: `.Codex/commands/references/ql-implement-patterns.md`.

#### Code Patterns

Reference code patterns:
`.Codex/commands/references/ql-implement-patterns.md`.
