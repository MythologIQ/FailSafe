...
|----------|----------|--------|
| AI Governance | `.agent/`, `.Codex/`, `.failsafe/`, `.qorelogic/` | Proprietary governance state |
| AI Instructions | `AGENTS.md`, `GEMINI.md`, `COPILOT.md`, `CURSOR.md` | Workspace-specific AI config |
...
- AI governance directories (`.agent/`, `.Codex/`, etc.)
- AI instruction files (`AGENTS.md`, `GEMINI.md`, etc.)
