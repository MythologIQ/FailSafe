...
Reference examples: `.Codex/commands/references/ql-refactor-examples.md`.
...
`.Codex/commands/references/ql-refactor-examples.md`.
...
Reference example: `.Codex/commands/references/ql-refactor-examples.md`.
...
Template: `.Codex/commands/references/ql-refactor-examples.md`.
