---
name: ql-validate
description: Merkle Chain Validator that verifies cryptographic integrity of the Meta Ledger. Use when: (1) Verifying chain integrity, (2) Detecting tampering or corruption, (3) Auditing history, or (4) Validating after manual edits.
---
