...
Reference implementation: `.Codex/commands/scripts/validate-ledger.py`.
...
Templates: `.Codex/commands/references/ql-validate-reports.md`.
...
Template: `.Codex/commands/references/ql-validate-reports.md`.
