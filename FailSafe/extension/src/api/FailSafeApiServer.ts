...
import type {
  EnforcementEngine,
  GovernanceMode,
} from "../governance/EnforcementEngine";
...
export class FailSafeApiServer {
  ...
  private resolvePort(): number {
    try {
      ...
      const extRuntime = raw?.["externalRuntime"] as
  ...
  private setupRoutes(): void {
    ...
    const deps: RouteDeps = {
      get enforcementEngine() {
        return self.enforcementEngine;
      },
      get intentService() {
        return self.intentService;
      },
      get sentinelDaemon() {
        return self.sentinelDaemon;
      },
      get qorelogicManager() {
        return self.qorelogicManager;
      },
      get ledgerManager() {
        return self.ledgerManager;
      },
      get riskManager() {
      ...
      get onModeChangeRequest() {
        return self.onModeChangeRequest;
      },
    };
