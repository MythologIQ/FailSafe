...
class L3ApprovalPanel {
    ...
    eventBus;
    disposables = [];
    constructor(panel, qorelogic, eventBus) {
        this.panel = panel;
    ...
    static createOrShow(extensionUri, qorelogic, eventBus) {
        if (L3ApprovalPanel.currentPanel) {
            L3ApprovalPanel.currentPanel.panel.reveal();
            return L3ApprovalPanel.currentPanel;
        }
        const panel = vscode.window.createWebviewPanel('failsafe.l3Approval', 'L3 Approval Queue', vscode.ViewColumn.One, { enableScripts: true, localResourceRoots: [extensionUri] });
    ...
    async handleApproval(id, decision) {
        try {
...
exports.L3ApprovalPanel = L3ApprovalPanel;
//# sourceMappingURL=L3ApprovalPanel.js.map