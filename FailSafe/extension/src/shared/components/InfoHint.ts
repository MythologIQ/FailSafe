...
export const HELP_TEXT = {
    sentinelMode: 'Heuristic: rule-based only. LLM-assisted: uses local model. Hybrid: combines both.',
    operationalMode: 'Operational mode controls monitoring intensity: NORMAL, LEAN, SURGE, or SAFE.',
    ...
    trustStages: 'CBT: Calculus-Based (0-50%). KBT: Knowledge-Based (50-80%). IBT: Identification-Based (80-100%).',
    ...
    verdictDecision: 'Sentinel decision outcome: PASS, WARN, BLOCK, ESCALATE, or QUARANTINE.',
    riskGrade: 'Risk grade classification. L1: low, L2: moderate, L3: critical.',
    noveltyLevels: 'Novelty tiers based on similarity scoring. Higher means less similar to known patterns.',
    ...
    trustScore: 'Trust score ranges 0.0 to 1.0 and influences verification weight.',
} as const;
