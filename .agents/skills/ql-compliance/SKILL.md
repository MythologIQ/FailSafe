...
2.  **Antigravity Constraints**:
    - Confirm all `.md` files in the Gemini-targeting directory have `description` fields ≤ 250 characters.
...
| **Antigravity Metadata** | [PASS/FAIL] | [Workflow descriptions ≤ 250 chars] |
